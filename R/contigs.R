...
#' \item{raw_clonotype_id}{The ID of the clonotype to which this cell barcode was assigned.}
#' \item{raw_consensus_id}{The ID of the consensus sequence to which this contig was assigned.}
